class Solution {
    public String longestDiverseString(int a, int b, int c) {
        ...
        while(a>0||b>0||c>0){
            ...
            if((a>=b && a >= c && !sub.equals("aa"))||((sub.equals("bb")||sub.equals("cc"))&&a>0)){
                res+="a";
                a--;
            }
            else if((b>=a && b>=c &&  !sub.equals("bb"))||( ( sub.equals("aa")||sub.equals("cc")) && b>0) ){
                res+="b";
                b--;
            }
            else if((c>= a && c >= b && !sub.equals("cc"))||((sub.equals("bb")||sub.equals("aa"))&&c>0)){
                res+="c";
                c--;
            }
